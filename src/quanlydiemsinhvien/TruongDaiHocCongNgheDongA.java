 ...
 * @author thuan
 */
public class TruongDaiHocCongNgheDongA extends javax.swing.JFrame {

    /**
     * Creates new form TruongDaiHocCongNgheDongA
     */
    public TruongDaiHocCongNgheDongA() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Dangnhap.setActionCommand("Đăng nhập");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TruongDaiHocCongNgheDongA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TruongDaiHocCongNgheDongA().setVisible(true);
            }
        });
    }
